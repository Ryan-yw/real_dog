...
% C=readmatrix('pitch.txt');  %pitch
% D=readmatrix('roll.txt');    %roll
% E=readmatrix('yaw.txt');     %yaw
% F=readmatrix('standup.txt');  %起立
angle=[A;C];
% angle=[A;B;C;D;E;F];

writematrix(angle,'R_angle.txt','Delimiter','tab');
