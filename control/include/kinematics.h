...
//const double L1_new_motor = 0.111;  //单位m
const double L1_new_motor = 0.134;  //单位m
...
static double foot_position_start_point[12] = {
                                         kBodyLong / 2 , -kBodyHigh, -(kBodyWidth / 2) - L1_new_motor ,  //leg1 ->012
                                        -kBodyLong / 2 , -kBodyHigh, -(kBodyWidth / 2) - L1,  //leg2 ->345
                                        -kBodyLong / 2 , -kBodyHigh,  (kBodyWidth / 2) + L1,   //leg3 ->678
                                         kBodyLong / 2 , -kBodyHigh,  (kBodyWidth / 2) + L1_new_motor   //leg4 ->91011
};
